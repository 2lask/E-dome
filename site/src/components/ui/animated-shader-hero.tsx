      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        {trustBadge && (
          <div className="mb-8 animate-[fade-in-down_0.8s_ease-out_forwards]">
            <div className="flex items-center gap-2 px-6 py-3 bg-[#ffe0c2]/10 backdrop-blur-md border border-[#ffe0c2]/30 rounded-full text-sm">
              <span className="text-[#ffe0c2]">{trustBadge.text}</span>
            </div>
          </div>
        )}
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          <div className="space-y-2">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-[#ffe0c2] via-[#ffdfb5] to-[#ffe0c2] bg-clip-text text-transparent">
              {headline.line1}
            </h1>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-[#ffdfb5] via-[#ffe0c2] to-[#ffdfb5] bg-clip-text text-transparent">
              {headline.line2}
            </h1>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
              {buttons.primary && (
                <button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-[#ffe0c2] to-[#ffdfb5] hover:opacity-90 text-[#111111] rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#ffe0c2]/25"
                >
              ...
              {buttons.secondary && (
                <button
                  ...
                  className="px-8 py-4 bg-[#ffe0c2]/10 hover:bg-[#ffe0c2]/20 border border-[#ffe0c2]/30 hover:border-[#ffe0c2]/50 text-[#ffe0c2] rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm"
                >
