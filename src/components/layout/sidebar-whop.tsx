    ...
    >
      ...
      <div className="flex-1 overflow-y-auto py-2">
        ...
        <div className="px-2 pb-2">
          <Link
            href="/publier"
            className="flex w-full items-center justify-center gap-1.5 rounded-md bg-foreground py-1.5 text-[12px] font-medium text-background hover:opacity-90 transition-opacity"
          >
      ...
      <div className="shrink-0 border-t border-border p-2">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate text-[12px] font-medium leading-tight">Léo Martin</p>
            <p className="truncate text-[10px] text-muted-foreground">Démo</p>
          </div>
        </Link>
      </div>
    </aside>
