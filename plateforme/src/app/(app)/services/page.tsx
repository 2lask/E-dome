...
const SERVICES = [
  { id: "s1", title: "Conciergerie premium Airbnb", category: "Conciergerie", provider: "Swiss Concierge", providerAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100", rating: 4.9, reviews: 127, price: 150, unit: "/mois", gradient: 0 },
  { id: "s2", title: "Transport de meubles Suisse romande", category: "Transport", provider: "TransLogistic SA", providerAvatar: "https://images.unsplash.com/photo-1507591064344-4c6ce005b128?w=100", rating: 4.7, reviews: 89, price: 80, unit: "/trajet", gradient: 1 },
  { id: "s3", title: "Photographie immobilière HD + drone", category: "Photographie", provider: "PixelHome", providerAvatar: "https://images.unsplash.com/photo-1504257432389-52343af06ae3?w=100", rating: 4.8, reviews: 203, price: 350, unit: "/séance", gradient: 2 },
  { id: "s4", title: "Décoration intérieure & home staging", category: "Décoration", provider: "Deco Studio", providerAvatar: "https://images.unsplash.com/photo-1554244933-d876deb6b2cd?w=100", rating: 4.6, reviews: 56, price: 200, unit: "/pièce", gradient: 3 },
  { id: "s5", title: "Conseil juridique immobilier", category: "Juridique", provider: "Cabinet Moreau", providerAvatar: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=100", rating: 4.9, reviews: 145, price: 250, unit: "/h", gradient: 4 },
  { id: "s6", title: "Gestion comptable locative", category: "Finance", provider: "FinImmo Conseil", providerAvatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100", rating: 4.5, reviews: 34, price: 120, unit: "/mois", gradient: 5 },
  { id: "s7", title: "Rénovation complète appartement", category: "Rénovation", provider: "RenovaPro", providerAvatar: "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=100", rating: 4.8, reviews: 178, price: 5000, unit: "/projet", gradient: 6 },
  { id: "s8", title: "Déménagement professionnel", category: "Déménagement", provider: "MoveSwiss", providerAvatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100", rating: 4.7, reviews: 92, price: 600, unit: "/déménagement", gradient: 7 },
  { id: "s9", title: "Gestion clés et accueil voyageurs", category: "Conciergerie", provider: "KeyMaster", providerAvatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100", rating: 4.6, reviews: 67, price: 30, unit: "/accueil", gradient: 8 },
];
