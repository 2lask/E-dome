...
const FORMATIONS = [
  { id: "f1", title: "Investissement immobilier : de 0 à expert", category: "Immobilier", level: "debutant" as const, instructor: INSTRUCTORS[0], thumbnail: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=600&h=400&fit=crop", price: 497, rating: 4.9, studentCount: 1240, duration: "12h", progress: 65, enrolled: true, featured: true, modules: 5 },
