...
const SECTIONS = [
  {
    ...
    content: `La presente Politique de Confidentialite decrit comment E-Dome Sarl (ci-apres "E-Dome", "nous") collecte, utilise, stocke et protege les données personnelles des utilisateurs de la plateforme E-Dome. Cette politique est conforme a la Loi federale suisse sur la protection des données (LPD, entree en vigueur le 1er septembre 2023) ainsi qu'au Reglement general sur la protection des données (RGPD) de l'Union europeenne, applicable aux utilisateurs situes dans l'UE/EEE.`,
  },
  {
    id: "responsable",
    title: "2. Responsable du traitement",
    content: `Le responsable du traitement des données est :\n\nE-Dome Sarl\nRue de la Gare 12\n2000 Neuchatel, Suisse\nEmail : dpo@edome.world\nTelephone : +41 32 000 00 00\n\nLe Delegue a la Protection des Données (DPO) peut etre contacte a l'adresse dpo@edome.world pour toute question relative au traitement de vos données personnelles.`,
  },
  {
    id: "collecte",
    title: "3. Données collectees",
    content: `Nous collectons les categories de données suivantes :\n\n**Données d'inscription :** nom, prenom, adresse email, numero de telephone, mot de passe (chiffre), pays de residence, langue preferee.\n\n**Données de profil :** photo de profil, biographie, certifications, langues parlees, roles actifs.\n\n**Données de transaction :** historique des reservations, montants, moyens de paiement (les données bancaires completes sont traitees par notre prestataire de paiement certifie PCI-DSS).\n\n**Données d'utilisation :** pages visitees, fonctionnalites utilisees, durée des sessions, adresse IP, type de navigateur, appareil utilise.\n\n**Données de communication :** messages echanges entre utilisateurs, historique du chat en direct, demandes de support.\n\n**Données de localisation :** ville et pays (jamais de geolocalisation precise sans consentement explicite).`,
  },
  {
    id: "finalites",
    title: "4. Finalites du traitement",
    content: `Vos données sont traitees pour les finalites suivantes :\n- Fourniture et amelioration des services de la Plateforme.\n- Gestion de votre compte et de vos preferences.\n- Traitement des transactions et versements de commissions.\n- Communication relative a votre compte (notifications, alertes).\n- Analyse statistique et amelioration de l'experience utilisateur.\n- Prevention de la fraude et securite de la Plateforme.\n- Respect de nos obligations legales et reglementaires.\n- Marketing direct (uniquement avec votre consentement prealable).`,
  },
  {
    id: "base-legale",
    title: "5. Base legale du traitement",
    content: `Le traitement de vos données repose sur les bases legales suivantes :\n- **Execution contractuelle :** traitement necessaire a la fourniture des services.\n- **Consentement :** pour le marketing direct et les cookies non essentiels.\n- **Interet legitime :** pour l'amelioration des services et la prevention de la fraude.\n- **Obligation legale :** pour les obligations fiscales et de conformite.`,
  },
  {
    id: "partage",
    title: "6. Partage des données",
    content: `Vos données peuvent etre partagees avec :\n- **Autres utilisateurs :** informations de profil public, annonces, avis.\n- **Prestataires de services :** hebergement (serveurs en Suisse), paiement, analyse, support.\n- **Autorites competentes :** sur requete legale ou judiciaire.\n\nNous ne vendons jamais vos données personnelles a des tiers. Tout transfert de données hors de Suisse ou de l'UE/EEE est encadre par des garanties appropriees (clauses contractuelles types, decisions d'adequation).`,
  },
  {
    id: "conservation",
    title: "7. Durée de conservation",
    content: `Vos données sont conservees pour la durée strictement necessaire aux finalites pour lesquelles elles ont ete collectees :\n- Données de compte : pendant la durée de votre inscription + 2 ans apres suppression.\n- Données de transaction : 10 ans (obligations legales suisses).\n- Données d'utilisation : 26 mois maximum.\n- Messages : 5 ans apres le dernier message.\n- Cookies : voir la section dediee ci-dessous.`,
  },
  {
    id: "droits",
    title: "8. Vos droits",
    content: `Conformement a la LPD et au RGPD, vous disposez des droits suivants :\n- **Droit d'acces :** obtenir une copie de vos données personnelles.\n- **Droit de rectification :** corriger des données inexactes ou incompletes.\n- **Droit a l'effacement :** demander la suppression de vos données (sous reserve des obligations legales).\n- **Droit a la portabilite :** recevoir vos données dans un format structure et lisible.\n- **Droit d'opposition :** vous opposer au traitement de vos données pour des motifs legitimes.\n- **Droit de retrait du consentement :** retirer votre consentement a tout moment sans affecter la legalite du traitement anterieur.\n- **Droit de reclamation :** introduire une reclamation aupres du Prepose federal a la protection des données (PFPDT) ou de l'autorite de controle competente.\n\nPour exercer vos droits, contactez-nous a dpo@edome.world. Nous repondrons dans un delai de 30 jours.`,
  },
  {
    id: "securite",
    title: "9. Securite des données",
    content: `Nous mettons en oeuvre des mesures techniques et organisationnelles appropriees pour proteger vos données :\n- Chiffrement des données en transit (TLS 1.3) et au repos (AES-256).\n- Authentification a deux facteurs disponible.\n- Acces restreint aux données (principe du moindre privilege).\n- Audits de securite reguliers.\n- Hebergement sur des serveurs certifies ISO 27001 en Suisse.\n- Plan de reponse aux incidents de securite.`,
  },
  {
    id: "cookies",
    title: "10. Cookies",
  ...
  },
  {
    ...
    content: `La Plateforme n'est pas destinee aux personnes de moins de 18 ans. Nous ne collectons pas sciemment de données personnelles de mineurs. Si nous apprenons que des données d'un mineur ont ete collectees, nous les supprimerons dans les plus brefs delais.`,
  },
  {
    id: "modifications",
