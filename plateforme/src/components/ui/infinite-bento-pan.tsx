...
export interface InfiniteBentoPanProps {
  ...
  className?: string;
  /**
   * Liste de URLs vidéo. Quand fournie, les cards de kind "video" du
   * layout sont alimentées par ces sources (cycliques modulo
   * `videos.length`). Les autres kinds (chart/code/stat/...) restent
   * inchangés.
   */
  videos?: string[];
}
...
/* Layout : on remplace une bonne partie des cards "synthétiques" du démo
   par des cards "video" pour pouvoir afficher la liste passée en prop.
   On garde quelques cards graphiques pour la variété visuelle (charts,
   gradients, code) — pas que des vidéos partout, plus bento-like. */
const CARDS: CardDef[] = [
  { x: 80, y: 80, w: 480, h: 280, kind: "video", hue: 220, label: "Reel 01" },
  { x: 600, y: 80, w: 280, h: 280, kind: "counter", hue: 280, label: "MRR" },
  { x: 920, y: 80, w: 360, h: 180, kind: "gradient", hue: 200 },
  { x: 1320, y: 80, w: 480, h: 280, kind: "video", hue: 0, label: "Reel 02" },
  { x: 1840, y: 80, w: 280, h: 280, kind: "logo", hue: 320 },
  { x: 2160, y: 80, w: 380, h: 180, kind: "stat", hue: 160, label: "Uptime" },
  { x: 2580, y: 80, w: 360, h: 280, kind: "video", hue: 40, label: "Reel 03" },
  ...
  { x: 400, y: 400, w: 480, h: 280, kind: "video", hue: 0, label: "Reel 04" },
  { x: 1320, y: 420, w: 280, h: 280, kind: "stat", hue: 60, label: "P95" },
  { x: 1640, y: 420, w: 380, h: 280, kind: "video", hue: 260, label: "Reel 05" },
  { x: 2580, y: 420, w: 360, h: 280, kind: "logo", hue: 200 },
  { x: 80, y: 720, w: 480, h: 240, kind: "video", hue: 290, label: "Reel 06" },
  ...
  { x: 1720, y: 740, w: 480, h: 240, kind: "video", hue: 0, label: "Reel 07" },
  ...
  { x: 880, y: 1000, w: 480, h: 220, kind: "video", hue: 200, label: "Reel 08" },
  ...
  { x: 2540, y: 1020, w: 400, h: 220, kind: "video", hue: 280, label: "Reel 09" },
  { x: 80, y: 1280, w: 480, h: 260, kind: "code", hue: 0, label: "edge.ts" },
  { x: 600, y: 1280, w: 360, h: 260, kind: "video", hue: 240, label: "Reel 10" },
  { x: 1000, y: 1280, w: 280, h: 260, kind: "logo", hue: 60 },
  { x: 1320, y: 1280, w: 380, h: 260, kind: "stat", hue: 200, label: "Hits" },
  { x: 1740, y: 1280, w: 360, h: 260, kind: "video", hue: 300, label: "Reel 01" },
...
function Card({
  ...
  if (card.kind === "video" && videoSrc) {
    // pas de label, vidéo en plein cadre — rendu plus immersif
    return (
...
export function InfiniteBentoPan({
  ...
  // Ne mappe les srcs que sur les cards "video" (cycliques sur videos.length)
  let videoCounter = 0;
    ...
    >
      ...
      >
        {CARDS.map((c, i) => {
          ...
          if (c.kind === "video" && videos && videos.length > 0) {
            videoSrc = videos[videoCounter % videos.length];
            videoCounter++;
          }
          return (
            <Card
