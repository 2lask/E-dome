...
export function useSlideProgress(slideIdx: number): MotionValue<number> {
  ...
  // Fenêtre = visibilité complète du slide (incoming + outgoing), soit
  // un segment entier de scroll (≈ 200 vh). La phase "activation
  // retardée" est gérée par la courbe d'interpolation côté consommateur
  // (ex. ZoomParallax tient scale=1 pour slideProgress < 0.5).
