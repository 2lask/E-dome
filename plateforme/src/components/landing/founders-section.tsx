...
export function FoundersSection() {
  ...
  return (
    <section className="bg-white py-20 md:py-32 px-20 overflow-hidden relative">
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-16 lg:gap-24 mb-20 md:mb-28">
          ...
          >
            <div className="w-40 h-40 md:w-52 md:h-52 mx-auto mb-6 chamfer-lg overflow-hidden border-4 border-gray-100 shadow-md">
              <img
            ...
            <div className="flex items-center gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center gap-2 chamfer-sm px-4 py-2 bg-[#1262b3]/10 border border-[#1262b3]/20 text-[#1262b3] text-xs font-medium hover:bg-[#1262b3]/20 transition-colors"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 chamfer-sm px-4 py-2 bg-[#f3f4f6] border border-gray-200 text-[#4b5563] text-xs font-medium hover:bg-gray-200 transition-colors"
              >
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {/* Conviction */}
            <div className="chamfer p-8 md:p-8 bg-[#FAFAF8] border border-gray-200">
